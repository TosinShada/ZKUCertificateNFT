...
describe("MyNFT", function () {
  it("Should mint and transfer an NFT to someone", async function () {
    ...
    const newlyMintedToken = await zkunft.payToMint(recipient, metadataURI, { value: ethers.utils.parseEther('0.05') });
    ...
    const newlyMintedToken2 = await zkunft.payToMint(recipient, 'foo', { value: ethers.utils.parseEther('0.05') });
  });
});
